...
namespace CreativeGurus.Weather.Wunderground
{
    public class WeatherClient : IWeatherClient
    {
        ...
        private string BaseUrl => _useSsl ? "https://api.wunderground.com/api" : "http://api.wunderground.com/api";

        public AlertResponse GetAlerts(QueryType queryType, QueryOptions options = null)
        {
            Service<AlertResponse> forecast = new Service<AlertResponse>(_apiKey, BaseUrl);
        ...
        {
            Service<AlmanacResponse> forecast = new Service<AlmanacResponse>(_apiKey, BaseUrl);
        ...
        {
            Service<AstronomyResponse> forecast = new Service<AstronomyResponse>(_apiKey, BaseUrl);
        ...
        {
            Service<ConditionsResponse> forecast = new Service<ConditionsResponse>(_apiKey, BaseUrl);
        ...
        {
            Service<ForecastResponse> forecast = new Service<ForecastResponse>(_apiKey, BaseUrl);
        ...
        {
            Service<GeoLookupResponse> forecast = new Service<GeoLookupResponse>(_apiKey, BaseUrl);
        ...
        {
            Service<HistoryResponse> forecast = new Service<HistoryResponse>(_apiKey, BaseUrl);
        ...
        {
            Service<HourlyResponse> forecast = new Service<HourlyResponse>(_apiKey, BaseUrl);
